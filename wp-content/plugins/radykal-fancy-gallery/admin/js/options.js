...
jQuery(document).ready(function($) {
	...
	//hide columns offset when columns is higher than 0
	$('input[name="columns"]').keyup(function() {

		if(this.value == '0') {
			$('input[name="column_offset"]').parents('tr').show();
		}
		else {
			$('input[name="column_offset"]').parents('tr').hide();
		}
