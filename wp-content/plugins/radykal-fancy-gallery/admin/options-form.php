<div class="options-container">
  ...
  <table class="table table-striped table-bordered table-hover">
  	<tbody>
	    ...
	    <tr>
	      <td>
		      <?php _e('Direction Aware Hover Effect', 'radykal'); ?>
		      <span title="<?php _e('You can change the opacity for the overlay in the thumbnail hover effect for overlay.', 'radykal'); ?>" class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom"></span>
		  </td>
	      <td>
		      <input type="checkbox" name="direction_aware_hover_effect" value="1" <?php checked($options['direction_aware_hover_effect'], 1) ?> />
		  </td>
	    </tr>
	    <tr>
	      <td>
  ...
  <div id="hover-effect-switcher" class="form-inline">
	  <div class="radio">
		  <label>
		    <input type="radio" name="thumbnail_hover_effect" value="fadeIn" <?php checked($options['thumbnail_hover_effect'], "fadeIn"); ?> /> Fade In
		  </label>
	  </div>
	  <div class="radio">
		  <label>
		    <input type="radio" name="thumbnail_hover_effect" value="fadeOut" <?php checked($options['thumbnail_hover_effect'], "fadeOut"); ?> /> Fade Out
		  </label>
	  </div>
	  <div class="radio">
		  <label>
		    <input type="radio" name="thumbnail_hover_effect" value="filter" <?php checked($options['thumbnail_hover_effect'], "filter"); ?> /> Filter
		  </label>
	  </div>
	  <div class="radio">
		  <label>
		    <input type="radio" name="thumbnail_hover_effect" value="icon" <?php checked($options['thumbnail_hover_effect'], "icon"); ?> /> Icon
		  </label>
	  </div>
	  <div class="radio">
		  <label>
		    <input type="radio" name="thumbnail_hover_effect" value="slide" <?php checked($options['thumbnail_hover_effect'], "slide"); ?> /> Slide
		  </label>
	  </div>
	  <div class="radio">
		  <label>
		    <input type="radio" name="thumbnail_hover_effect" value="scale" <?php checked($options['thumbnail_hover_effect'], "scale"); ?> /> Scale
		  </label>
	  </div>
	  <div class="radio">
		  <label>
		    <input type="radio" name="thumbnail_hover_effect" value="overlay" <?php checked($options['thumbnail_hover_effect'], "overlay"); ?> /> Overlay
		  </label>
	  </div>
  </div>
  <table id="hover-effects-options" class="table table-striped table-bordered table-hover">
	  ...
	  <tbody id="overlay" class="<?php echo $options['thumbnail_hover_effect'] == 'overlay' ? '' : 'hidden'; ?>">
	  	<tr>
	      <td><?php _e('Opacity', 'radykal'); ?></td>
