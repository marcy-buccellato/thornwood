...
array( "name" => "Columns",
	"desc" => "Select default Column for each media block, you can also set this manually when adding shortcode.<br><br><a target='_blank' href='http://demo.ghozylab.com/content/pro.html?utm_source=procp&utm_medium=settingspage&utm_campaign=gotodemoprocp'>Upgrade</a> to PRO and you can choose up to 8 columns.",
...
array( "name" => "Alignment",
	"desc" => "Select thumbnails alignment. Default: Center<br><br><a target='_blank' href='http://demo.ghozylab.com/content/pro.html?utm_source=procp&utm_medium=settingspage&utm_campaign=gotodemoprocp'>Upgrade</a> to PRO and you can choose center, left or right alignment.",
...
array( "name" => "Video Size",
	"desc" => "Adjust the video size. Default size for all video : width 700px,  height 400px.<br><br><a target='_blank' href='http://demo.ghozylab.com/content/pro.html?utm_source=procp&utm_medium=settingspage&utm_campaign=gotodemoprocp'>Upgrade</a> to PRO and get HTML5 video player.",
...
array( "name" => "Video Auto Play",
	"desc" => "Use this to enable/disable video auto play. This feature only work on MP4, M4V, Youtube, Vimeo, Google Video and Veoh.<br><br><a target='_blank' href='http://demo.ghozylab.com/content/pro.html?utm_source=procp&utm_medium=settingspage&utm_campaign=gotodemoprocp'>Upgrade</a> to PRO and get HTML5 video player.",
	"id" => $theshort."_disen_autoplv",
	"type" => "checkbox",
	"std" => "1"),		
		
array( "name" => "Audio Auto Play",
	"desc" => "Use this to enable/disable audio auto play. This feature only work for MP3 media type.<br><br><a target='_blank' href='http://demo.ghozylab.com/content/pro.html?utm_source=procp&utm_medium=settingspage&utm_campaign=gotodemoprocp'>Upgrade</a> to PRO and get HTML5 audio player.",
	"id" => $theshort."_disen_autopl",
	"type" => "checkbox",
	"std" => "1"),	
	
array( "name" => "Audio Loop",
	"desc" => "Use this to enable/disable audio loop. This feature only work for MP3 media type.<br><br><a target='_blank' href='http://demo.ghozylab.com/content/pro.html?utm_source=procp&utm_medium=settingspage&utm_campaign=gotodemoprocp'>Upgrade</a> to PRO and get HTML5 audio player.",
	"id" => $theshort."_disen_audio_loop",
	"type" => "checkbox",
	"std" => "1"),	
	
array( "name" => "Audio Volume",
	"desc" => "Set the default volume for audio media. <br><br><a target='_blank' href='http://demo.ghozylab.com/content/pro.html?utm_source=procp&utm_medium=settingspage&utm_campaign=gotodemoprocp'>Upgrade</a> to PRO and get HTML5 audio player.",
...
array( "name" => "Media Box Style",
	"desc" => "Select media box style. Default: Light<br><br><a target='_blank' href='http://demo.ghozylab.com/content/pro.html?utm_source=procp&utm_medium=settingspage&utm_campaign=gotodemoprocp'>Upgrade</a> to PRO and get more styles such as Dark Style or Transparent Style.",
...
array( "name" => "Thumbnail Size",
	"desc" => "Allow for editing thumbnail sizes. Default sizes width 180px, height : 180px.<br><br><a target='_blank' href='http://demo.ghozylab.com/content/pro.html?utm_source=procp&utm_medium=settingspage&utm_campaign=gotodemoprocp'>Upgrade</a> to PRO and you can set this manually when adding shortcode.",
...
array( "name" => "Pattern Overlay",
	"desc" => "Define pattern for box overlay.<br><br><a target='_blank' href='http://demo.ghozylab.com/content/pro.html?utm_source=procp&utm_medium=settingspage&utm_campaign=gotodemoprocp'>Upgrade</a> to PRO and you can choose up to 15 patterns.",
...
array( "name" => "Hover Style",
	"desc" => "Enable or disable image hover effect.<br><br><a target='_blank' href='http://demo.ghozylab.com/content/pro.html?utm_source=procp&utm_medium=settingspage&utm_campaign=gotodemoprocp'>Upgrade</a> to PRO and you can set the title to show permanent on top or bottom position.",
