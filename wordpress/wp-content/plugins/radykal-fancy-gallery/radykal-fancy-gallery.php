...
if(!class_exists('FancyGallery')) {
	class FancyGallery {
	    ...
	    public function __construct() {
			...
			$this->maximum_filesize = 1024 * 15000;
			...
			$this->default_options = array(//layout
										   ...
										   'direction_aware_hover_effect' => 0,
		...
		public function enqueue_styles() {
			...
			wp_enqueue_style( 'font-awesome', '//netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.css', false, '3.2.1' );
	   ...
	   private function file_upload_error_message($error_code) {
		...
		public function get_js_code($options, $selector, $selectAlbum) {
			...
			if($options['gallery'] == 'prettyphoto') {
				...
				if( !$options['prettyphoto_social_tools'] ) { $prettyphoto_options .= ", social_tools: ''"; }
			}
  ...
  jQuery('#".$selector."').fancygallery({
	  ...
	  directionAwareHoverEffect: ". $options['direction_aware_hover_effect'] .",
