	...
	jQuery.fn.fancygallery = function(arg){
		...
		function _createAlbumThumbnail() {
			...
			if(options.thumbnailSelectionOptions.layout == 'default') {
				albumSelector.append('<li class="fg-album-thumbnail" style="width: '+options.thumbnailSelectionOptions.width+'px; border-color: '+options.borderColor+';"><a href="#" style="height: '+options.thumbnailSelectionOptions.height+'px;"><img src="" /></a><div style="background: '+options.backgroundColor+'; color: '+options.titleOptions.color+';"><div class="fg-album-thumbnail-title"></div><div class="fg-album-thumbnail-length"></div></div></li>');
			}
			//polaroid layout
			else {
				albumSelector.append('<li class="fg-album-polaroid"><span class="fg-album-thumbnail-length"></span><a href="#"><img src="" /></a><p class="fg-album-thumbnail-title"></p></li>');
			}

			albumSelector.children('li:last').show().children('a').click(function(evt) {
			...
			$thumbnailContainer.click(function() {
				...
				if(options.lightbox == 'inline') {
					...
					var _appendMedia = function(mediaHtml) {
						...
						$inlineMediaContainer.css({height: options.inlineGalleryOptions.height})
